...
public class CreateUserViewModelValidator : AbstractValidator<CreateUserViewModel>
{
    public CreateUserViewModelValidator()
    {
        ...
        RuleFor(x => x.ProfileImageFile)
            .NotNull().WithMessage("Profil fotoğrafı boş olamaz.")
            .Must(file => file == null || IsImageFile(file)).WithMessage("Sadece JPEG, PNG, GIF veya WEBP formatında dosya yükleyebilirsiniz.");
    }
